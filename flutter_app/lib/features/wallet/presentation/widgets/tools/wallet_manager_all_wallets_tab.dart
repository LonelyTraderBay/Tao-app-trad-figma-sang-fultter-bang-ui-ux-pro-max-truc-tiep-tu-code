...
import 'package:vit_trade_flutter/features/wallet/presentation/widgets/tools/wallet_manager_distribution_chart.dart';
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              VitAccentIconBox(
                icon: wallet.type == 'hot'
                    ? Icons.account_balance_wallet_outlined
                    : Icons.shield_outlined,
                color: Color(wallet.typeColorHex),
                boxSize: WalletSpacingTokens.walletManagerWalletTypeIconBox,
                iconSize: WalletSpacingTokens.walletManagerWalletTypeIcon,
                bordered: false,
              ),
              const SizedBox(
