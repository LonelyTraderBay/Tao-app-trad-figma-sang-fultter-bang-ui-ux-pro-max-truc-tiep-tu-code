...
///
/// Lives in `trade_core` (not `trade`) because its only consumer is
/// `trade_terminal`'s advanced-chart page, not `trade` itself — moved here
/// to avoid `trade_terminal` depending on a sibling module's presentation
/// folder for a widget `trade` never used.
