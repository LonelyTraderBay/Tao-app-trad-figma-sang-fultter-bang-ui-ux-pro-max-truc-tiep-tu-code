...
/// Tablet main-column equivalent of Home's private `_MarketSection`
/// (`home_page_sections.dart`, phone-only — not importable outside
/// `home_page.dart`'s `part` family). Same Hot/Tăng/Giảm/Mới watchlist, but
/// rendered as a persistent panel in `HomeTabletPage`'s primary column
/// instead of the last block in a single phone scroll.
...
class _WatchlistRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return VitMarketPairRow(
      ...
      title: pair.symbol,
      subtitle: 'Vol \$${_formatVolumeBillions(pair.volume24h)}B',
...
String _formatVolumeBillions(double value) => (value / 1e9).toStringAsFixed(2);
