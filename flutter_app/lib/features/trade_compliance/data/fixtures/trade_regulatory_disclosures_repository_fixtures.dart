...
const List<TradeClientCategoryInfo> _clientCategorizationCategories = [
  TradeClientCategoryInfo(
    ...
    description: 'Nhà đầu tư cá nhân với bảo vệ quy định tối đa',
    protections: [
      'Bắt buộc kiểm tra phù hợp đầy đủ',
      'Nghĩa vụ thực thi tốt nhất',
      'Bồi thường nhà đầu tư tới EUR 100k',
      'Công bố chi phí và phí chi tiết',
      'Bảo vệ số dư âm',
      'Quyền khiếu nại tới ombudsman',
      'Thời gian cân nhắc 14 ngày',
      'Bảo vệ quản trị sản phẩm',
    ],
    requirements: [
      'Cá nhân tự nhiên',
      'Giao dịch trên tài khoản cá nhân',
      'Không đáp ứng tiêu chí chuyên nghiệp',
    ],
  ),
  TradeClientCategoryInfo(
    id: 'professional',
    label: 'Khách hàng chuyên nghiệp',
    description: 'Nhà đầu tư có kinh nghiệm, có thể từ bỏ một số bảo vệ',
    protections: [
      'Có thể miễn kiểm tra phù hợp',
      'Nghĩa vụ thực thi tốt nhất, giảm',
      'Bồi thường nhà đầu tư hạn chế',
      'Công bố chi phí đơn giản hóa',
      'Quản trị sản phẩm, giảm',
    ],
    requirements: [
      'Danh mục trên EUR 500.000',
      'Khối lượng giao dịch trên 10 lệnh mỗi quý',
      'Kinh nghiệm làm việc tài chính từ 1 năm',
      'Giữ vị trí đòi hỏi kiến thức tài chính',
    ],
  ),
  TradeClientCategoryInfo(
    id: 'ecp',
    label: 'Đối tác đủ điều kiện',
    description: 'Tổ chức với mức bảo vệ tối thiểu',
    protections: [
      'Không áp dụng quy tắc ứng xử kinh doanh',
      'Không bồi thường nhà đầu tư',
      'Yêu cầu công bố tối thiểu',
    ],
    requirements: [
      'Công ty đầu tư',
      'Tổ chức tín dụng',
      'Công ty bảo hiểm',
      'UCITS và quỹ hưu trí',
      'Cơ quan chính phủ',
    ],
  ),
];
...
const List<TradeClientCategoryHistory> _clientCategorizationHistory = [
  TradeClientCategoryHistory(
    ...
    action: 'categorized',
    toCategoryId: 'retail',
    reason: 'Đăng ký tài khoản lần đầu',
  ),
  TradeClientCategoryHistory(
    date: '2025-12-15',
    ...
    reason: 'Người dùng gửi hồ sơ đủ điều kiện',
  ),
];
