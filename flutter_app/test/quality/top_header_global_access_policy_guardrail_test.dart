...
void main() {
  test('top header global access policy audit artifacts are current', () {
    final result = Process.runSync(_dartExecutable(), [
      'run',
      'tool/top_header_global_access_policy_audit.dart',
      '--check',
    ]);
    ...
    expect(
      ...
      reason:
          ...
          'from flutter_app/ and resolve global search/notification policy '
          'violations.',
    );
  });
}
