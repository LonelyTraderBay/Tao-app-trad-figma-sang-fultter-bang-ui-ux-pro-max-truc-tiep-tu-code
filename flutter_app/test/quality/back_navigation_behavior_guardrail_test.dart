...
void main() {
  test('back navigation behavior audit artifacts are current and strict', () {
    final result = Process.runSync(_dartExecutable(), [
      'run',
      'tool/back_navigation_behavior_audit.dart',
      '--check',
      '--strict',
    ]);
    ...
    expect(
      ...
      reason:
          'stdout:\n${result.stdout}\n\nstderr:\n${result.stderr}\n'
          'Run `dart run tool/back_navigation_behavior_audit.dart` from '
          'flutter_app/ and resolve strict back-navigation violations.',
    );
  });
}
