...
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_reviews_page.dart';
...
void main() {
  ...
  test('SC-231 mock repository exposes P2P reviews BE draft', () {
    final snapshot = const MockP2PRepository().getReviews();
