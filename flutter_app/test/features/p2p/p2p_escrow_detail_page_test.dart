...
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_escrow_detail_page.dart';
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_order_page.dart';
...
void main() {
  ...
  test('SC-246 mock repository exposes escrow detail BE draft', () {
    final snapshot = const MockP2PRepository().getEscrowDetail('p2p001');
