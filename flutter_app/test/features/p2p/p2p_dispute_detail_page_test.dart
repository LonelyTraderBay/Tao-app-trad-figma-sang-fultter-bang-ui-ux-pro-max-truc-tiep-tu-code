...
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_dispute_detail_page.dart';
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_dispute_evidence_page.dart';
import 'package:vit_trade_flutter/features/p2p/presentation/p2p_disputes_page.dart';
...
void main() {
  ...
  test('SC-218 mock repository exposes P2P dispute detail BE draft', () {
    final snapshot = const MockP2PRepository().getDisputeDetail('sample');
