...
void main() {
  test('Withdraw controller exposes preview state and validation boundary', () {
    final container = ProviderContainer();
    addTearDown(container.dispose);

    final controller = container.read(
      withdrawControllerProvider((asset: 'USDT', assetScoped: false)),
    );
  ...
  test('Address add controller builds high-risk confirmation preview', () {
    final container = ProviderContainer();
    addTearDown(container.dispose);

    final controller = container.read(addressAddControllerProvider);
  ...
  test('Token approval controller owns revoke confirmation copy', () {
    final container = ProviderContainer();
    addTearDown(container.dispose);

    final controller = container.read(tokenApprovalControllerProvider);
