// Smoke + logic test for MockMarketRepository: exercises every method on the
// MarketRepository interface against the mock implementation.
//
// Most getters are thin pass-through builders around static fixture data and
// are covered with compact isA<...>() / non-empty checks. A handful of
// methods contain real sort/filter logic (screener, calendar, derivatives,
// social sentiment, portfolio, news, advanced charts, token unlocks, social
// signals, correlations) — those get dedicated tests that assert the actual
// comparator direction and filtered subset against known fixture values.
