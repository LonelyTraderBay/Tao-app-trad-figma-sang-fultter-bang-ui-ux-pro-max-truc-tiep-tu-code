...
import 'package:vit_trade_flutter/features/dca/presentation/dca_schedule_analytics_page.dart';
...
void main() {
  ...
  testWidgets('SC-173 renders React baseline missing config state', (
    tester,
  ) async {
