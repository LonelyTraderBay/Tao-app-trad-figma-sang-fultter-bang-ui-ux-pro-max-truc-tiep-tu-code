...
import 'package:vit_trade_flutter/features/trade/presentation/pages/arm_integration_status_page.dart';
import 'package:vit_trade_flutter/features/trade/presentation/pages/regulatory_reports_dashboard_page.dart';
import 'package:vit_trade_flutter/features/trade/presentation/pages/transaction_reporting_page.dart';
...
void main() {
  ...
  test('SC-094 mock repository exposes regulatory reports BE draft', () {
    final snapshot = const MockTradeRepository()
