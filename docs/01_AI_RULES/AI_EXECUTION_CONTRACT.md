...
- Before implementing a Flutter screen, check the Flutter foundation docs for app structure, tokens, component mapping, routing, and visual QA.
...
4. Check `Flutter-Design-Tokens.md`, `Flutter-Component-Mapping.md`, and `Flutter-Navigation-Routing.md`.
...
8. Capture/compare the Flutter result against both reference screenshots.
9. Tick Flutter, BE, and QA status only after the screen passes acceptance checks.
