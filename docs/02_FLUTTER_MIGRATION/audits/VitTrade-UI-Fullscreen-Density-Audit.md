...
P2_visual_density_review=31
P3_followup_review=18
Pass_or_low_signal=360
```
...
| P2_visual_density_review | 12 | trade | TradePage | `'/trade/:pairId'` | body B; few dense sections/cards=2 | `flutter_app/lib/features/trade/presentation/pages/trade_page.dart` |
| P2_visual_density_review | 12 | trade | TradePage | `AppRoutePaths.trade` | body B; few dense sections/cards=2 | `flutter_app/lib/features/trade/presentation/pages/trade_page.dart` |
