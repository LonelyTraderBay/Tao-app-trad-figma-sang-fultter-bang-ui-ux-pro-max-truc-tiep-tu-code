...
| search_action | module_search | `lib/features/predictions/presentation/pages/hub/predictions_home_page.dart` | 124 | yes | - | Module/discovery search action is allowlisted. |
