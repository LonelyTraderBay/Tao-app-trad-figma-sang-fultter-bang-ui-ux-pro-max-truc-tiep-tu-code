...
| HEB-006 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 199 | Recent Copy Trade source is present. |
| HEB-030 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 190 | Recent Staking source is present. |
| HEB-007 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 41 | Quick action Mua nhanh source is present. |
| HEB-008 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 48 | Quick action Convert source is present. |
| HEB-009 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 125 | Quick action Margin source is present. |
| HEB-010 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 132 | Quick action Bot source is present. |
| HEB-011 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 139 | Quick action Copy Trade source is present. |
| HEB-012 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 70 | Quick action DCA source is present. |
| HEB-013 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 56 | Quick action Wallet source is present. |
| HEB-014 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 62 | Quick action P2P source is present. |
| HEB-015 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 76 | Quick action Staking source is present. |
| HEB-016 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 84 | Quick action Savings source is present. |
| HEB-017 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 90 | Quick action Launchpad source is present. |
| HEB-018 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 98 | Quick action Predictions source is present. |
| HEB-019 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 104 | Quick action Arena source is present. |
| HEB-020 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 112 | Quick action Rewards source is present. |
| HEB-021 | Matrix source | `lib/features/home/data/home_mock_data.dart` | PASS | line 119 | Quick action Support source is present. |
