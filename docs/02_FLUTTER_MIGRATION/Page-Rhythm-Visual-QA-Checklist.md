...
**Emulator deep routes:** `Capture-PhoneVisualQaDeepRoutes.ps1` — **12/12 screenshots** in `run-artifacts/phone-visual-qa/`. Full report: [Page-Rhythm-Phone-Visual-QA-Report.md](./Page-Rhythm-Phone-Visual-QA-Report.md).
...
All verified: **19/19** phone widget test. Details: [Page-Rhythm-Phone-Visual-QA-Report.md](./Page-Rhythm-Phone-Visual-QA-Report.md).
